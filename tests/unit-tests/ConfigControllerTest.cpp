...
public:
    ConfigControllerTest() : TestCase() {
        this->configController = new REDBetterR::Config::ConfigController(this->mockConfigModel, this->mockConfigView);
    }

    MockConfigModel mockConfigModel;
    MockConfigView mockConfigView;
    REDBetterR::Config::ConfigController* configController;
